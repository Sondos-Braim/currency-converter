import { GET_AVAILABLE_CURRENCIES, GET_AVAILABLE_CURRENCIES_FAILED, SET_CHOSEN_CURRENCY, SET_CHOSEN_CURRENCY_FAILED, SET_IS_SELECTOR_OPEN, CONVERT_CURRENCY, CONVERT_CURRENCY_FAILED, SET_EXCHANGE_RATE, SET_EXCHANGE_RATE_FAILED } from '../types';
    ...
    try {
        ...
        headers: {
            ...
            dispatch({
                ...
                payload: {USD: USDRate.data.rates[payload], EUR: EURRate.data.rates[payload]}
            });
    } catch (e) {
        console.log(e)
        dispatch({
